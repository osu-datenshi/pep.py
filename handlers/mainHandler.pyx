...
class handler(requestsManager.asyncRequestHandler):
	...
	@tornado.gen.engine
	def asyncGet(self):
		html = "<!DOCTYPE html> <head> <meta charset='utf-8'> <meta http-equiv='X-UA-Compatible' content='IE=edge'> <title>DATENSHI</title> <meta name='description' content='DATENSHI BACKEND'> <meta name='viewport' content='width=device-width, initial-scale=1'> <link rel='icon' href='https://i.troke.id/static/logos/text-white.png'> <style>body{background-color: blueviolet;}.img-container{text-align: center; display: block;}h1, p, a{color: aliceblue; font-family: Arial, Helvetica, sans-serif;}</style> </head>"
