...
class handler(requestsManager.asyncRequestHandler):
	...
	def asyncPost(self):
		...
		if requestTokenString is None:
			...
			try:
				...
				responseData += serverPackets.notification("Oh no! Datenshi have something wrong at the moment... Maybe try login again?")
	...
	@tornado.gen.engine
	def asyncGet(self):
		html = "<!DOCTYPE html> <head> <meta charset='utf-8'> <meta http-equiv='X-UA-Compatible' content='IE=edge'> <title>DATENSHI</title> <meta name='description' content='DATENSHI BACKEND'> <meta name='viewport' content='width=device-width, initial-scale=1'> <link rel='icon' href='https://i.osu.troke.id/static/logos/text-white.png'> <style>body{background-color: blueviolet;}.img-container{text-align: center; display: block;}h1, p, a{color: aliceblue; font-family: Arial, Helvetica, sans-serif;}</style> </head>"
		html += "<body> <div class='img-container'> <img src='https://osu.troke.id/static/logo2.png'> <h1>DATENSHI</h1> <p>So you are here? If you do understand exactly what you are doing, you should come work with us <a href='https://github.com/osu-datenshi'>/github</a></p></div></body></html>"
